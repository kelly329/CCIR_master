...
<div class="container">
    <div class="form row">
        <form class="form-horizontal col-sm-offset-3 col-md-offset-3" id="login_form" action="/CCIR_master/index.php/Home/User/register" method="post">
