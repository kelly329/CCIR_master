    ...
    <div class="ibox-content m-b-sm border-bottom">
        <div class="row">
            <div class="col-sm-11 p-xs">
                ...
                <h2>用户意见反馈</h2>
                <span>管理并回复比赛信息推荐网前台用户意见反馈信息</span>
            </div>
            ...
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    <div class="row">
                        ...
                        <form action="/CCIR_master/index.php/Admin/System/opinion" type="get">
                        ...
                        <div class="col-sm-1">
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li><a href="/CCIR_master/index.php/Admin/System/opinion/type/3">只显示待办</a></li>
                                    <li><a href="/CCIR_master/index.php/Admin/System/opinion/type/2">显示已忽略</a></li>
                                    <li><a href="/CCIR_master/index.php/Admin/System/opinion/type/1">显示已处理</a></li>
                                    <li class="divider"></li>
                                    <li><a href="/CCIR_master/index.php/Admin/System/opinion/type/4">显示全部</a></li>
                                </ul>
                            </div>
                    ...
                    <table class="table table-hover">
                        ...
                        <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                                ...
                                <td><a class="text-navy"
                                       href="/CCIR_master/index.php/Admin/System/opiniondetail/id/<?php echo ($vo["id"]); ?>/type/<?php echo ($_GET['type']); ?>">查看详情</a>
                                </td>
