    ...
    <div class="row">
        <div class="ibox">
            <div class="ibox-content">
                <form id="form" action="/CCIR_master/index.php/Admin/Contest/editcontest" method="post"
                      enctype="multipart/form-data">
                    <input type="text" class="hidden" value="<?php echo ($info["contestid"]); ?>" name="contestId" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-7">
                                <div class="uploadimage">
                                    ...
                                    <!--</a>-->
                                    <img src="/CCIR_master/<?php echo ($info["picurl"]); ?>" height="250" style="max-width: 500px"
                                         id="preview"/>
                                </div>
                            </div>
                            <div class="clear"></div>
                    ...
                    <div class="row">
                        <div class="form-groups">
                            ...
                            <div class="col-lg-5">
                                <input type="text" class="form-control" value="<?php echo ($info["sourcename"]); ?>"
