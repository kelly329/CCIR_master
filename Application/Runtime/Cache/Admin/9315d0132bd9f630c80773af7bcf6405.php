                ...
                <div class="ibox-content">
                    <div class="row">
                        ...
                        <div class="col-sm-3 pull-left">
                            <div class="input-group">
                                <input type="text" placeholder="按照用户名搜索" class="input-sm form-control" name="username" value="<?php echo ($_GET['username']); ?>">
                    ...
                    <table class="table table-hover">
                        ...
                        <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                                ...
                                <td style="max-width: 300px"><?php echo(subtext($vo['title'],50));?></td>
                                <td>
                                    <?php if($vo["ispass"] == '1'): ?><span class="label label-default">审核通过</span>
                                        <?php elseif($vo["ispass"] == '0'): ?>
                                        <span class="label  label-primary">待办</span>
                                        <?php elseif($vo["ispass"] == '2'): ?>
                                        <span class="label  label-danger">审核不通过</span><?php endif; ?>
                                </td>
                                <td><a class="text-navy"
                                       href="/CCIR_master/index.php/Admin/Fuser/recommendetail/id/<?php echo ($vo["id"]); ?>/type/<?php echo ($_GET['type']); ?>">查看详情</a>
                                </td>
