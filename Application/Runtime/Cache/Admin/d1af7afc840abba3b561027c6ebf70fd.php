...
<div class="wrapper wrapper-content animated fadeInDown">
    <div class="ibox-content m-b-sm border-bottom">
        <div class="row">
            <a href="/CCIR_master/index.php/Admin/System/opinion<?php echo $_GET['type']?'/type/'.$_GET['type']:'';?>">
            ...
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    <div class="pull-right">
                        <label>管理员处理: </label>
                        <a href="/CCIR_master/index.php/Admin/System/opiniondetail/id/<?php echo ($info["id"]); ?>/action/1">
                            <button class="btn btn-success btn-xs" type="button">已解决</button>
                        </a>
                        <a href="/CCIR_master/index.php/Admin/System/opiniondetail/id/<?php echo ($info["id"]); ?>/action/2">
                            <button class="btn btn-danger btn-xs" type="button">已忽视</button>
                        </a>
                    </div>
                    <div class="small m-b-xs">
                            <h2><?php echo ($info["username"]); ?></h2>
                        <?php if(empty($info[contact]) != true): ?><br/> 
                             <span>
                             <i class="fa fa-envelope-o"></i> <?php echo ($info["contact"]); ?> |
                             </span>   
                        <?php else: ?>
                             <br/> 
                             <span>
                    ...
                    <!--回复功能-->
                    <?php if($info[userid] != '0'): ?><form action="/CCIR_master/index.php/Admin/System/comment/id/<?php echo ($info["id"]); ?>" method="post">
